...
if ($_SERVER['REQUEST_METHOD'] === 'POST') { //se for enviado guarda os dados no banco
    $titulo = $_POST['titulo'];
    $autor  = $_POST['autor'];
    $genero = $_POST['genero'];
    $resumo = $_POST['resumo'];
...
$query = "INSERT INTO livros (titulo, autor, genero, resumo, imagem)
          VALUES ('$titulo', '$autor', '$genero', '$resumo', '$nome')"; //insere os dados na tabela livros
...
<body>
    ...
    <div class="caixa-login"> <!-- bloco de login, Reutilizado -->
